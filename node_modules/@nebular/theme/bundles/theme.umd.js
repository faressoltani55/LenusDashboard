...
class NbDynamicOverlay {
    constructor(overlay, componentFactoryResolver, zone, overlayContainer) {
        ...
        this.destroy$ = new rxjs.Subject();
        this.overlayDestroy$ = new rxjs.Subject();
    }
    get isAttached() {
    ...
    updatePositionWhenStable(overlay) {
        const overlayDestroy$ = this.overlayDestroy$.pipe(rxjs_operators.filter((destroyedOverlay) => destroyedOverlay === overlay));
        this.zone.onStable
            .pipe(rxjs_operators.takeUntil(rxjs.merge(this.destroy$, overlayDestroy$)))
...
class NbContextMenuDirective {
    constructor(hostRef, menuService, dynamicOverlayHandler) {
        ...
        this._position = exports.NbPosition.BOTTOM;
        /**
         * Container position will be changes automatically based on this strategy if container can't fit view port.
